...
import preset from '../packages/css-allin-class/src/presetRules/preset';
import { genCssValue, genStyle } from '../packages/css-allin-class/src/styles';
import { createStyleSheet } from '../packages/css-allin-class/src/styles/createStyleSheet';
let rules = preset().rules
let unit = 'rpx'

describe('预设规则', async () => {
	let styleSheet =  await createStyleSheet({ userConfig:{
		presets:[preset]
	} })
